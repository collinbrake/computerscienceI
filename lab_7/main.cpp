/*
    ...
    All rights reserved.
    Computer Science I - LAB 07 
    Author: Collin Brake
        cmb361@zips.uakron.edu
    Purpose: Practice debugging on a buggy previous assignment. Gain experience
      with debugger in the IDE.
*/
...
int main()
{
   ...
   while (true)
   {
      ...
      cout << endl
           << std::fixed << "The area from your choice is: " << area << endl;
